/*
	header for puzzle solver class, the solver class holds the puzzle generated by the generator class, as well as the subset of all possible shapes used to 
